...
{h}|   |  |
	                 ...
	                 {m}★{k}★{h}★OPENMYACCOUNT{u}{h}★{k}★{m}★{u}
{m}★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}•{h} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}•{u} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}• {k} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}• {h} ★''')
...
def menu(my_name,my_id):
	...
	print(f'{h}Selamat Datang{u} %s {k}SI ANAK HARAM'%(my_name)) 
	popen_xd(f'{u}ID  : '+str(my_id))
	popen_xd(f'{h}IP  : {ip}')
	popen_xd(f'{m}★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}•{h} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}•{u} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}• {k} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}• {h} ★') 
	print(f'{b}PILIH PENGEN NGAPAIN LO')
	print(f'{u}[1] Crack Ba Id publick    {k}♥     {u}[2] CrackBa Follower\n{u}[3] Crack ba Grup     {k}  🙂     {u}[4] Crack ba File\n{u}[5]  Crack     {k} 🙂    {u}[0] DARCHUN\n{m}★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}•{h} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}•{u} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}• {k} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}• {b} ★') 
...
def dump_massal():
	try:
		...
		exit()
		print(f'{u}Pastikan Gunakan ID publik...') 
	try:
		jum = int(input('CHAN ID DA ANEY ? : '))
	except ValueError:
		print(f'{k}➣SALAH KETIK KAU GOBLOK ')
		exit()
	if jum<1 or jum>100:
	...
	try:
		print('')
		print(f'{k}[+]HAMW ID KAN★{b}'+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{u}')
...
def setting():
	...
	print(f'{m}★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}•{h} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}•{u} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}• {k} ★\n{b}MAU TIPE AKUN YANG MANA ?')
	print(f'{u}[1] Akun Old \n{u}[2] Akun New\n{u}[3] Random\n{m}★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}•{h} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}•{u} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}• {k} ★') 
	print('')
	hu = input('➣Pilih : ')
	if hu in ['1','01']:
		...
		exit()
	print(f'{m}★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}•{h} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}•{u} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}• {k} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}• {u} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}• {b} ★\n{b}PILIH METODE LOGIN MU') 
	print(f'{u}[1] Mobile(Sangat Disarankan)     {k}♥     {u}[2] Mbasic(Disarankan)\n{u}[3] Touch     {k}                    ♥     {u}[4] Mtouch\n{m}★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}•{h} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}•{u} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}• {k} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}• {u} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}• {b} ★') 
	print('')
	hc = input('>> Pilih : ')
	if hc in ['1','01']:
...
#		method.append('touch')
		...
		method.append('mobile')
	print(f'{m}★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}•{h} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}•{u} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}• {k} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}• {b} ★\n{m}CATATAN :\n🎀{u}DISARANKAN TIDAK MENAMPILKAN APLIKAS\n🎀DISARANKAN GUNAKAN PASWORD DEPAULT\n{m}★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}•{h} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}•{u} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}• {k} ★  {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}• {b} ★') 
	print('')
...
def passwrd():
	print(f'{m}★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}•{h} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}•{u} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}• {k} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}• {b} ★\nSELAMAT MENUNGGU HASIL, SEMOGA BERUNTUNG')
	print(f'{m}★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}•{h} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}•{u} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}• {k} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}• {b} ★\n\n               {m}H {k}A {h}R {u}A {b}P {u}  ★  {b}S {u}A {h} B{k} A{m} R{u}')
	print('')
	print(f'Hasil {h}OK{u} Tersimpan Di : {h}OK/%s {u}'%(okc))
	print(f'Hasil {k}CP{h} Tersimpan Di : {k}CP/%s {u}'%(cpc))
	...
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			...
			if 'mobile' in method:
				...
				pool.submit(crackmbasic,idf,pwv)
	print('')
	print(f'{k}CRACK SELESAI........')
	print(f'[{h}•{u}]{h} OK : {h}%s '%(ok))
	print(f'{k}[{k}•{h}]{k} CP : {k}%s{u} '%(cp))
	print('')
	print(f'{k}Lanjut Crack Kembali ( Y/t ) ? ')
	woi = input('➣Pilih : ')
	if woi in ['y','Y']:
		back()
	else:
		print(f'\t{h}➣{k} BY : POPEN NOPRIANSYAH{u} ')
		time.sleep(5)
		exit()
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{x}🐢{P}[{x}{loop}{P}/{h}{len(id)}{P}]🐢{P}[{H}{ok}{P}]🐢{P}[{k}{cp}{x}]🐢[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
